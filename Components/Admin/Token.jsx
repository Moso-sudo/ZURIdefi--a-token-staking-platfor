      ...
      <div className="invest__group">
        ...
        />
          <p className="invest__text">
            Stake TIMBUKTU Tokens and earn rewards, while enjoying, security, transparency and seamless token staking experience
          </p>
          ...
          <table className="invest__table">
            ...
            <tbody>
              ...
              <tr>
                <td>Total Supply</td>
                <td>{token?.totalSupply} {token?.
                symbol}</td>
              </tr>

              <tr>
                <td>Total Stake</td>
                <td>{token?.contractTokenBalance || "0"} {token?.
                symbol}</td>
              </tr>


              <tr>
                <td> Token Explorer</td>
                <td>
