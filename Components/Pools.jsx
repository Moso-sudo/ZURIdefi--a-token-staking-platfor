...
import { MdOutlineAttachMoney, FaRegCopy } from "./ReactICON";
        ...
        <div className="row">
          {
            poolArray.map((pool, index)=>(
              ...
              <div key={index} className={`col-12 ${index ===0 || index ===1 ?
                "col-md-6": index===2 ? "" : ""
              } col-lg-4`}>
                <div className="apool">
                  <h3 className="apool__title">
                    {index ==0 ?  "Maximum"
                    :index ==1 ? "Standard" : index==2 ? "Lite" :"Advance" }

                  </h3>

                  <ul className={`nav nav-tabs apool__tabs apool__tabs--${

                    index ==0 ?  "orange"
                    :index ==1 ? "green" : index==2 ? "blue" :"orange" 
                  }`}
                  id={
                    index ==0 ?  "apool__tabs1"
                    :index ==1 ? "apool__tabs2" : index==2 ? "apool__tabs3" :"" 
                  }
                  role="tablist"
                  >
              ...
              <div className="tab-content">
                ...
                >
                  <div className="apool__content">
                    <span className="apool__value">
                      <b>{pool?.depositToken.symbol} &nbsp; </b>: {pool?.depositToken.address.slice(0,18)}...{""}
                      <FaRegCopy/>
                    </span>

                    <span className="apool__value">
                      <b>{pool?.rewardToken.symbol} &nbsp; </b>: {pool?.depositToken.address.slice(0,18)}...{""}
                      <FaRegCopy/>
                      </span>
              ...
              >Invest</button>
              <span className={`block-icon block-icon--${
                index==0
                ?"orange"
                :index==1
                ? "green"
